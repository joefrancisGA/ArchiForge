...
/// <summary>
///     Maps persisted 59R improvement plans into deterministic 60R <see cref="CandidateChangeSet" /> projections (no
///     execution or persistence).
/// </summary>
public interface ICandidateChangeSetService
{
    /// <summary>
    ///     Produces one aggregate change set (all steps), plus one change set per action step when the plan has multiple
    ///     steps.
