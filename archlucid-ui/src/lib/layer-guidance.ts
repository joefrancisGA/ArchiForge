...
export const LAYER_PAGE_GUIDANCE: Record<LayerGuidancePageKey, LayerGuidanceBlock> = {
  ...
  "governance-dashboard": {
    ...
    firstPilotNote: "Skip until cross-run triage is routine.",
  ...
  alerts: {
    ...
    useWhen: "Inbox first; thresholds and routing live under Alert tooling.",
    firstPilotNote: "Skip rules work until the inbox is real.",
    enterpriseFootnote: "Inbox first; rules and routing are follow-on.",
  },
  audit: {
    layerBadge: "Enterprise Controls",
    headline: "Answers: tenant audit trail—who did what, when?",
    useWhen: "Search first; CSV uses the same From/To (Auditor/Admin on API).",
    firstPilotNote: "Skip CSV until window and export roles are clear.",
  ...
  "governance-resolution": {
    ...
    useWhen: "Read the stack before editing packs or workflow elsewhere.",
    firstPilotNote: "Skip until ordering is the question.",
  ...
  "governance-workflow": {
    ...
    firstPilotNote: "Skip until SoD or promotions apply.",
  ...
  "policy-packs": {
    ...
    useWhen: "Inspect inventory and effective JSON; lifecycle last.",
