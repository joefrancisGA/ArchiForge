...
/// <summary>
///     Per-tenant LLM token budgets over a sliding time window (prompt and completion tokens from Azure OpenAI
///     usage).
/// </summary>
public sealed class LlmTokenQuotaOptions
{
    ...
    /// <summary>
    ///     When true, <see cref="ArchLucid.AgentRuntime.LlmCompletionAccountingClient" /> enforces limits before each
    ///     completion call.
    /// </summary>
    public bool Enabled
    {
