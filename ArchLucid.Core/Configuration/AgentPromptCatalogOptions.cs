...
/// <summary>
/// Configuration for optional per-agent <strong>release</strong> labels (A/B, pilot) layered on built-in prompt templates.
...
public sealed class AgentPromptCatalogOptions
{
    ...
    /// <summary>Per <c>agentTypeKey</c> (<c>topology</c>, <c>compliance</c>, …) release label stored on traces and OTel (e.g. <c>experiment-a</c>).</summary>
