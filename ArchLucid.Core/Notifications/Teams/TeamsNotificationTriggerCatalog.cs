...
public static class TeamsNotificationTriggerCatalog
{
    ...
    /// <summary>Default JSON payload for the SQL column when a tenant has not explicitly chosen \u2014 mirrors the migration default in 107.</summary>
    ...
    /// <summary>Deserialize <paramref name="json"/> into a deduplicated list of catalog triggers, dropping unknown / blank entries.</summary>
    /// <remarks>
    ...
    /// <summary>Serialize <paramref name="enabledTriggers"/> after filtering to known catalog entries; deterministic ordering matches <see cref="All"/>.</summary>
