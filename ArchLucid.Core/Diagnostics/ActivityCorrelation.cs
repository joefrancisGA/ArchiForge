...
/// </summary>
/// <remarks>
///     HTTP requests set <see cref="LogicalCorrelationIdTag" /> in <c>CorrelationIdMiddleware</c>. Child activities
///     started
///     during the request may become <see cref="Activity.Current" />; audit enrichment walks the parent chain so
///     <see cref="ArchLucid.Core.Audit.AuditEvent.CorrelationId" /> still matches the client <c>X-Correlation-ID</c> when
///     unset.
/// </remarks>
public static class ActivityCorrelation
{
    ...
    /// <summary>
    ///     Returns the first non-empty <paramref name="tagName" /> value walking from <paramref name="start" /> to
    ///     parents.
    /// </summary>
