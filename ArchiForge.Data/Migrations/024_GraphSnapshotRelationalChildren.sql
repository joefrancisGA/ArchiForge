-- Relational children for dbo.GraphSnapshots (dual-write; JSON retained). Mirrors ArchiForge.Data/SQL/ArchiForge.sql. GraphSnapshotEdges unchanged for ListIndexedEdgesAsync.
