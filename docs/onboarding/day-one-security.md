...
- [ ] **2. AuthZ model** — Map **Admin / Operator / Reader** (Entra app roles) to API policies **ReadAuthority / ExecuteAuthority / AdminAuthority** ([API_CONTRACTS.md](../API_CONTRACTS.md#security-schemes-swashbuckle), [appsettings.Entra.sample.json](../../ArchLucid.Api/appsettings.Entra.sample.json)).
