...
- [ ] **4. Migrations posture** — Confirm **`ArchiForge.DatabaseMigrator`** / DbUp ordering matches your release process; skim [runbooks/MIGRATION_ROLLBACK.md](../runbooks/MIGRATION_ROLLBACK.md) for “forward-only” expectations.
