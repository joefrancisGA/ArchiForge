...
Six standalone prompts, one per improvement from the archived assessment [`docs/archive/QUALITY_ASSESSMENT.md`](../archive/QUALITY_ASSESSMENT.md) (stub: [`docs/QUALITY_ASSESSMENT.md`](../archive/quality/2026-04-23-doc-depth-reorg/QUALITY_ASSESSMENT.md)). Each is ready to paste into a Cursor Agent session.
