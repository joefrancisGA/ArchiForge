...
| **2.9** Pilot readiness | [`PILOT_GUIDE.md`](library/PILOT_GUIDE.md), [`RELEASE_SMOKE.md`](library/RELEASE_SMOKE.md) | `release-smoke.ps1`, `v1-rc-drill.ps1`, [`docs/library/V1_RC_DRILL.md`](library/V1_RC_DRILL.md) | *(scripts — run `.\release-smoke.ps1` from repo root)* | Playwright may use mocks — see V1_SCOPE **out of scope** table. |
