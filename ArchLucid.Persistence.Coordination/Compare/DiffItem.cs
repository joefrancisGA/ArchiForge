...
/// </summary>
/// <remarks>
///     <see cref="DiffKind" /> is typically one of <see cref="DiffKind.Added" />, <see cref="DiffKind.Removed" />,
///     <see cref="DiffKind.Changed" />, or <see cref="DiffKind.Unchanged" /> (unchanged is unused by current comparer).
/// </remarks>
...
public class DiffItem
{
    ...
    /// <summary>
    ///     Left-hand value for <see cref="Compare.DiffKind.Changed" /> or <see cref="Compare.DiffKind.Removed" /> items;
    ///     <see langword="null" /> for additions.
    /// </summary>
    ...
    /// <summary>
    ///     Right-hand value for <see cref="Compare.DiffKind.Changed" /> or <see cref="Compare.DiffKind.Added" /> items;
    ///     <see langword="null" /> for removals.
    /// </summary>
