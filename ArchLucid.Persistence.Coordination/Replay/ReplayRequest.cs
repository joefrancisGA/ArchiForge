...
public class ReplayRequest
{
    ...
    /// <summary>
    ///     One of <see cref="ReplayMode.ReconstructOnly" />, <see cref="ReplayMode.RebuildManifest" />, or
    ///     <see cref="ReplayMode.RebuildArtifacts" /> (case-insensitive match in the implementation).
    /// </summary>
    public string Mode
    {
        get;
