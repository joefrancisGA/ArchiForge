...
/// <remarks>
///     <para>
///         <see cref="SqlReadReplicaSettings.FailoverGroupReadOnlyListenerConnectionString" /> is the Azure SQL failover
///         group
///         <strong>secondary read-only</strong> endpoint. When both it and
///         <see cref="SqlReadReplicaSettings.AuthorityRunListReadsConnectionString" />
///         are set, run lists prefer the legacy key (backward compatibility); governance and manifest lookups prefer the
///         failover listener first.
///     </para>
/// </remarks>
public static class SqlReadReplicaConnectionStringResolver
{
    /// <summary>
    ///     Returns a trimmed connection string to open directly, or <see langword="null" /> to use the primary resilient
    ///     factory.
    /// </summary>
