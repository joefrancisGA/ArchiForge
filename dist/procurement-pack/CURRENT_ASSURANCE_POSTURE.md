...
|-------|-----------|---------|
| **Identity** | Microsoft Entra ID (OIDC / JWT) with app roles (Admin, Operator, Reader, Auditor); optional API keys for automation | [`docs/library/SECURITY.md`](../../docs/library/SECURITY.md) |
...
| **Database** | SQL Server row-level security (RLS) with `SESSION_CONTEXT` per request; tenant ID enforced on covered tables | [`docs/security/MULTI_TENANT_RLS.md`](../../docs/security/MULTI_TENANT_RLS.md) |
| **Network** | Optional Azure Front Door + WAF; private endpoints for Azure SQL and Blob; no public SMB (port 445) | [`docs/library/CUSTOMER_TRUST_AND_ACCESS.md`](../../docs/library/CUSTOMER_TRUST_AND_ACCESS.md) |
| **Secrets** | Azure Key Vault references for application configuration in hosted deployments | [`docs/library/CONFIGURATION_KEY_VAULT.md`](../../docs/library/CONFIGURATION_KEY_VAULT.md) |

**Evidence:** [`docs/go-to-market/TENANT_ISOLATION.md`](../../docs/go-to-market/TENANT_ISOLATION.md)
...
**Evidence:** [`docs/library/AUDIT_COVERAGE_MATRIX.md`](../../docs/library/AUDIT_COVERAGE_MATRIX.md), [`docs/library/AUDIT_RETENTION_POLICY.md`](../../docs/library/AUDIT_RETENTION_POLICY.md)
...
|----------|-------|---------|
| STRIDE system threat model | Full product boundary (API, SQL, LLM, Blob, Service Bus, billing webhooks, trial lifecycle) | [`docs/security/SYSTEM_THREAT_MODEL.md`](../../docs/security/SYSTEM_THREAT_MODEL.md) |
| ASK/RAG threat model | Natural-language query surface (prompt injection, data exfiltration, context poisoning) | [`docs/security/ASK_RAG_THREAT_MODEL.md`](../../docs/security/ASK_RAG_THREAT_MODEL.md) |
| LLM prompt redaction | Configurable deny-list redaction before Azure OpenAI; aligned trace persistence redaction | [`docs/runbooks/LLM_PROMPT_REDACTION.md`](../../docs/runbooks/LLM_PROMPT_REDACTION.md) |
...
|----------|--------|---------|
| SOC 2 self-assessment (Security + Availability) | **Completed** (internal; not CPA attestation) | [`docs/security/SOC2_SELF_ASSESSMENT_2026.md`](../../docs/security/SOC2_SELF_ASSESSMENT_2026.md) |
...
| CAIQ Lite pre-fill (CSA STAR) | **Completed** | [`docs/security/CAIQ_LITE_2026.md`](../../docs/security/CAIQ_LITE_2026.md) |
| SIG Core pre-fill (Shared Assessments) | **Completed** | [`docs/security/SIG_CORE_2026.md`](../../docs/security/SIG_CORE_2026.md) |
| Compliance control matrix | **Completed** | [`docs/security/COMPLIANCE_MATRIX.md`](../../docs/security/COMPLIANCE_MATRIX.md) |
| Data Processing Agreement template | **Completed** (requires legal review) | [`docs/go-to-market/DPA_TEMPLATE.md`](../../docs/go-to-market/DPA_TEMPLATE.md) |
| GDPR DSAR process | **Completed** | [`docs/security/DSAR_PROCESS.md`](../../docs/security/DSAR_PROCESS.md) |
| Subprocessors register | **Completed** | [`docs/go-to-market/SUBPROCESSORS.md`](../../docs/go-to-market/SUBPROCESSORS.md) |
...
| Owner-conducted security self-assessment | **Completed** (interim posture) | [`docs/security/OWNER_SECURITY_ASSESSMENT_2026_Q2-DRAFT.md`](../../docs/security/OWNER_SECURITY_ASSESSMENT_2026_Q2-DRAFT.md) |
...
**Evidence:** [`infra/`](../../infra/), [`docs/library/DEPLOYMENT_TERRAFORM.md`](../../docs/library/DEPLOYMENT_TERRAFORM.md)
