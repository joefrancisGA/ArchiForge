...
{
    /// <summary>
    /// Name of the environment variable whose value is the full ADO.NET connection string for <strong>ArchiForge.Persistence.Tests</strong>
    ...
    /// <summary>
    /// Name of the environment variable for optional <strong>ArchiForge.Api.Tests</strong> SQL host (server + auth).
