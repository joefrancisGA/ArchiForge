...
///     <see cref="ArchLucid.Persistence.Orchestration.IAuthorityRunOrchestrator" />, then materializes coordinator
///     contracts (run, evidence bundle, starter agent tasks).
/// </summary>
/// <remarks>
///     Implementation: <see cref="CoordinatorService" />. Primary consumer:
///     <c>ArchLucid.Application.ArchitectureRunService</c> (registered scoped in API).
/// </remarks>
public interface ICoordinatorService
{
    /// <summary>
    ///     Validates required fields, executes the persistence orchestrator, and builds topology/cost/compliance/critic
    ///     starter tasks plus metadata-only <see cref="KnowledgeGraph.Models.GraphSnapshot" /> shell for downstream agents.
    /// </summary>
