...
public sealed class EmbeddedResourceEvidencePackSourceProviderTests
{
    ...
    public void OrderedZipNames_ContainsTheNineExpectedProcurementArtefacts()
    {
        ...
        ordered.Should().Equal("DPA-template.md", "SUBPROCESSORS.md", "SLA-summary.md", "security.txt", "CAIQ-Lite.md", "SIG-Core.md", "OWNER_SECURITY_ASSESSMENT_2026_Q2-DRAFT.md", "PEN_TEST_SOW_2026_Q2.md", "AUDIT_COVERAGE_MATRIX.md");
    }
