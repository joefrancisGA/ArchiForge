...
/// <summary>
///     Turns analyzed <see cref="ImprovementSignal" /> values into prioritized <see cref="ImprovementRecommendation" />
///     items, optionally adjusted by a learning profile.
/// </summary>
/// <remarks>
///     Default implementation: <see cref="RecommendationGenerator" /> (singleton in API composition). Called from
///     <see cref="ImprovementAdvisorService" /> after
///     <see cref="ArchLucid.Decisioning.Advisory.Analysis.IImprovementSignalAnalyzer" /> runs.
/// </remarks>
public interface IRecommendationGenerator
{
    /// <summary>
    ///     Produces ordered recommendations (highest <see cref="ImprovementRecommendation.PriorityScore" /> first, then
    ///     title).
    /// </summary>
