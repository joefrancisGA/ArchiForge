...
{
    /// <summary>
    ///     Multiplies <see cref="AdaptiveScoringInput.BasePriorityScore" /> by category, urgency, and optional signal-type
    ///     weights when present in <paramref name="profile" />.
    /// </summary>
    ...
    /// <returns>
    ///     Base and adapted integers plus per-facet weights and human-readable <see cref="AdaptiveScoringResult.Notes" />
    ///     .
    /// </returns>
