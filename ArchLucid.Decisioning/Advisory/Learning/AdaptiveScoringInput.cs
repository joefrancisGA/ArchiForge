...
/// <summary>
///     Inputs for <see cref="IAdaptiveRecommendationScorer.Score" /> aligned with recommendation facets before
///     persistence.
/// </summary>
public class AdaptiveScoringInput
{
    /// <summary>
    ///     Recommendation category (matches <see cref="RecommendationLearningProfile.CategoryWeights" /> keys when
    ///     learned).
    /// </summary>
    ...
    /// <summary>
    ///     Optional signal/type facet (matches <see cref="RecommendationLearningProfile.SignalTypeWeights" /> when
    ///     learned).
    /// </summary>
