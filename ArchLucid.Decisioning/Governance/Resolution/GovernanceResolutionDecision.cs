...
/// <summary>
///     Explainability record: which policy pack version won for a single logical item (e.g. one alert rule id or metadata
///     key).
/// </summary>
/// <remarks>
///     Populated by <see cref="EffectiveGovernanceResolver" /> for every distinct item key after merge. The first
///     candidate in
///     <see cref="Candidates" /> after ordering is the winner (<see cref="GovernanceResolutionCandidate.WasSelected" />
///     set to <c>true</c>).
/// </remarks>
