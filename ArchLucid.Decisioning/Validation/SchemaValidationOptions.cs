...
public sealed class SchemaValidationOptions
{
    ...
    public string ExplanationRunSchemaPath { get; set; } = "schemas/explanation-run.schema.json";

    public string ComparisonExplanationSchemaPath { get; set; } = "schemas/comparison-explanation.schema.json";
