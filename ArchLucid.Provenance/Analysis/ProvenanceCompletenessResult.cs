...
{
    /// <summary>
    ///     Decisions that satisfy finding, graph-context, and rule linkage (see
    ///     <see cref="ProvenanceCompletenessAnalyzer" />).
    /// </summary>
    ...
    /// <summary>
    ///     0.0–1.0 — <see cref="DecisionsCovered" /> / <see cref="TotalDecisions" />; 1.0 when
    ///     <see cref="TotalDecisions" /> is 0.
    /// </summary>
    ...
    public IReadOnlyList<string> UncoveredDecisionKeys
    {
        get;
        init;
    } = [];
