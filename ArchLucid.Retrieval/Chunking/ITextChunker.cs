...
/// <summary>
///     Splits long document text into overlapping windows before embedding in
///     <see cref="ArchLucid.Retrieval.Indexing.RetrievalIndexingService" />.
/// </summary>
public interface ITextChunker
{
    ...
    /// <param name="overlap">
    ///     Characters reused between consecutive windows (<paramref name="maxChars" /> −
    ///     <paramref name="overlap" /> advance step).
    /// </param>
