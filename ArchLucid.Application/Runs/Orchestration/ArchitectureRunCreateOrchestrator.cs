...
{
    private readonly byte __primaryConstructorArgumentValidation = __ValidatePrimaryConstructorArguments(authorityCoordination, requestRepository, runRepository, scopeContextProvider, evidenceBundleRepository, taskRepository, architectureRunIdempotencyRepository, actorContext, baselineMutationAudit, auditService, unitOfWorkFactory, usageMetering, distributedCreateRunIdempotencyLock, createRunOptions, timeProvider, requestContentSafetyPrecheck, logger);
