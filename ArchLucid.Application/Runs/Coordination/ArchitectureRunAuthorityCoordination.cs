...
///     starter tasks).
/// </summary>
public sealed class ArchitectureRunAuthorityCoordination(IAuthorityRunOrchestrator authorityRunOrchestrator, IRunRepository runRepository, IScopeContextProvider scopeContextProvider, ILogger<ArchitectureRunAuthorityCoordination> logger) : IArchitectureRunAuthorityCoordination
{
    private readonly byte __primaryConstructorArgumentValidation = __ValidatePrimaryConstructorArguments(authorityRunOrchestrator, runRepository, scopeContextProvider, logger);
    private static byte __ValidatePrimaryConstructorArguments(ArchLucid.Persistence.Orchestration.IAuthorityRunOrchestrator authorityRunOrchestrator, ArchLucid.Persistence.Interfaces.IRunRepository runRepository, ArchLucid.Core.Scoping.IScopeContextProvider scopeContextProvider, Microsoft.Extensions.Logging.ILogger<ArchLucid.Application.Runs.Coordination.ArchitectureRunAuthorityCoordination> logger)
    {
