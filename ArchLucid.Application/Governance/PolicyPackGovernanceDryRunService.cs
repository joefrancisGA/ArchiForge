...
{
    private readonly byte __primaryConstructorArgumentValidation = __ValidatePrimaryConstructorArguments(scopeContextProvider, runRepository, findingsSnapshotRepository, goldenManifestRepository, preCommitOptions, promptRedactor, auditService, logger);
