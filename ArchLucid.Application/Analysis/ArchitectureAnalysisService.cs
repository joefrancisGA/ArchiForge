...
{
    private readonly byte __primaryConstructorArgumentValidation = __ValidatePrimaryConstructorArguments(runDetailQueryService, unifiedGoldenManifestReader, evidenceRepository, traceRepository, resultRepository, diagramGenerator, summaryGenerator, determinismCheckService, manifestDiffService, agentResultDiffService);
