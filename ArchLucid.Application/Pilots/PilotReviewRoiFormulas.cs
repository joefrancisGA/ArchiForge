...
/// <summary>
///     ROI math aligned with <c>docs/go-to-market/ROI_MODEL.md</c> §2 status-quo annual review cost and §3.1 50%
///     architect-hour
...
public static class PilotReviewRoiFormulas
{
    ...
    public static decimal AnnualReviewCostStatusQuo(decimal reviewsPerQuarter, decimal hoursPerReview,
        decimal hourlyCost)
    {
        return reviewsPerQuarter * 4m * hoursPerReview * hourlyCost;
    }
    ...
    public static decimal AnnualReviewCostWithArchLucidReviewLever(
        ...
        decimal hourlyCost)
    {
        return reviewsPerQuarter * 4m * (hoursPerReview * 0.50m) * hourlyCost;
    }

    /// <summary>
    ///     Difference between status quo and reduced-hour model (equals half of <see cref="AnnualReviewCostStatusQuo" />
    ///     when inputs match).
    /// </summary>
    public static decimal AnnualReviewSavings(
        ...
        decimal hourlyCost)
    {
        return AnnualReviewCostStatusQuo(reviewsPerQuarter, hoursPerReview, hourlyCost)
